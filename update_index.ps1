$file = "c:\Users\user\Documents\GitHub\generasipenerus\index.html"
$lines = Get-Content $file
$startLine = 2049
$endLine = 2427

$pre = $lines[0..($startLine - 2)]
$post = $lines[($endLine)..$lines.Count]

$newContent = @"
      <!-- Section: Kenapa Program SMI Cocok -->
...
$finalLines = $pre + $newContent + $post
